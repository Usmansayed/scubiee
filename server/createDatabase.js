...
async function syncModels(db, force = false) {
  try {
    ...
    const modelCreationOrder = [
      ...
      'Post',          // Depends on Users (fixed: was 'Posts')
      ...
      'Papers',        // Depends on Users
      'PaperPosts',    // Depends on Papers and Posts (moved after Papers)
      'Communities',   // Depends on Users
      'CommunityMemberships', // Depends on Communities and Users
      'CommunityPosts', // Depends on Communities and Posts

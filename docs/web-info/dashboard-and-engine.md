...
**Cause (fixed in 0.2.50):** On Windows, process group creation made the spawned PID differ from the PID reported in health JSON.

**Fix:** Upgrade to **scubiee 0.2.50+** and retry:

...
**Docs assume [scubiee 0.3.13](https://pypi.org/project/scubiee/0.3.13/).** Full playbook: [Install & debug](./install-and-debug.md).
...
Or: `scripts/repair-uv-scubiee.ps1 0.3.13`.
